...
- Uses retrieval confidence + KB term coverage to politely redirect out-of-scope questions
- Filters generated text to keep only sentences grounded in retrieved KB context
...
- `python rag_cli.py --min-retrieval-score 0.05 --min-kb-coverage 0.25 --min-query-terms-for-scope-check 2 --min-sentence-grounding 0.65`
