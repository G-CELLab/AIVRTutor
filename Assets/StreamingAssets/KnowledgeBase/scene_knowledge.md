...
1. Place three green nutrient capsules into the mitochondria:
   - Protein (first capsule)
   - Magnesium (second capsule)
   - Vitamin C (third capsule)
...
3. Replicate the centriole:
   - Find the yellow barrel-shaped centriole on the left side.
   - Grab it and move it to create a duplicate.
   - Two centrioles should appear at opposite sides of the cell after replication.
...
- The centrosomes (centrioles) organize the spindle apparatus that will move chromosomes in later phases.
...
2. Hold it steady for about 3 seconds:
   - Keep the DNA stable and stationary.
...
3. Observe the spindle fibers:
   - Yellow spindle fibers are visible and appear to hold chromosomes in place.
...
**What to do in Telophase:** Watch the cell complete mitosis. Chromosomes are now at opposite poles and new nuclear envelopes reform. Prepare to exit.

### Next steps and instructions:
1. Observe chromosome arrival:
   - Watch as the two sets of chromatids/chromosomes reach opposite poles of the cell.
...
3. Exit the cell:
   - Navigate to the cell exit and leave the blood cell scene.
...
### Short guidance examples
- "In Telophase, exit the cell, then touch the wound again to start the next healing cycle."
- "What should you do? Watch the nuclei reform and then exit to see the divided cells."
- "The cell has successfully divided into two. Exit now and return to continue healing."
